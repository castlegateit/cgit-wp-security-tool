...
class SecurityTool
{
     ...
     */
    private $google_recaptcha_disabled = false;
    ...
    /**
     * Enables Google reCAPTCHA support on login.
     *
     * @return void
     */
    private function enableGoogleRecaptcha()
    {
        ...
        if (empty($site_key) || empty($secret_key)) {
            $this->displayWarning('Google reCAPTCHA configuration keys have not been set.');
            return;
        }
     ...
     * @return bool
     */
    public function disableGoogleRecaptcha()
    {
        ...
        if (array_intersect($plugins, get_option('active_plugins'))) {
            $this->google_recaptcha_disabled = true;
        }
    }
     ...
     * @return void
     */
    public function displayGoogleRecaptcha()
    {
        if ($this->google_recaptcha_disabled) {
            return;
        }
     ...
     * @return void
     */
    public function errorGoogleRecaptcha()
    {
        if ($this->google_recaptcha_disabled) {
            return;
        }
     ...
     * @return void
     */
    public function googleRecaptchaProcess()
    {
        if ($this->google_recaptcha_disabled) {
            return;
        }
